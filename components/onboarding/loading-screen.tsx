...
export function LoadingScreen({ email }: { email: string }) {
  return (
      ...
      <div className="space-y-4">
        <div>
          ...
          <Input
            ...
            value={email}
            disabled
            className="h-12 rounded-lg border-0 bg-[#333736] text-white placeholder:text-white/50"
          />
        </div>

        <Button disabled className="h-14 w-full rounded-full bg-[#f86701] text-base font-semibold text-white">
          Loading...
        </Button>

        <div className="py-4 text-center text-sm text-white/70">Or sign up with the options below</div>
